  ...
  <div class="pathology-info-ctn-wrap">
    <div class="info-wrap clinical-info-wrap">
      <div
        ...
        ref="infoTopWrap0"
        v-if="diseaseInfo.diseaseInfoModel[0]"
      >
        <div class="clinical-top-wrap">
          <!-- 诊断分期：diseaseInfo.diseaseInfoModel[0] -->
      ...
      <!-- 临床表现：diseaseInfo.diseaseInfoModel[1].disease_info_title -->
      <div class="clinical-info-middle-wrap">
        ...
        >
          <div class="clinical-m-middle-tz-wrap">
            ...
            <div
              class="tz-r-wrap"
              v-if="diseaseInfo.diseaseInfoModel[1].children[2].children"
            >
              <template
        ...
        <div
          class="clinical-m-middle-wrap"
          v-if="diseaseInfo.diseaseInfoModel[1].children[3]"
        >
          <div class="clinical-m-middle-tz-wrap">
            <p class="tx-label-wrap">
              <span class="TNM-label"
                >{{
                  diseaseInfo.diseaseInfoModel[1].children[3]
                    .disease_info_title
                }}:</span
              >
            </p>
            <div
              class="tz-r-wrap"
              v-if="diseaseInfo.diseaseInfoModel[1].children[3].children"
            >
              <template
                v-for="(item, index) in diseaseInfo.diseaseInfoModel[1]
                  .children[3].children"
        ...
        <div class="clinical-m-middle-wrap clinical-m-middle-tz-wrap-noline">
          <div class="clinical-m-middle-tz-wrap">
            ...
            <div
              class="tz-r-wrap"
              v-if="diseaseInfo.diseaseInfoModel[1].children[1].children"
            >
              <template
                v-for="(item, index) in diseaseInfo.diseaseInfoModel[1]
                  .children[1].children"
