<template>
  <div class="list-wrap" v-loading="loading"
    ...
    <DiseaseDetailHeaderTable v-if = '!loading' @onPushDetail = 'onPushDetail' class="home-card-wrap" :listInfo = 'listInfo'></DiseaseDetailHeaderTable>
  </div>
</template>
...
export default {
  ...
  mounted () {
    this.$store.dispatch('diseaseEntry/apiPostAtientTableSelect', { disease_name: this.$route.query.disease_name })
  },
  methods: {
    onChangeTab (tab) {
